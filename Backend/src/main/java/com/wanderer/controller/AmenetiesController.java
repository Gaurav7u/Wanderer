...
public class AmenetiesController {
	...
	public ResponseEntity<AmenetiesModel> insertAmeneties( @Valid @RequestBody() AmenetiesDto ameneties,@PathVariable int packageId)
			throws IOException{
	...
	@DeleteMapping("{id}")
	public ResponseEntity<String> deleteAmeneties(@PathVariable int id) throws NotFoundException {
